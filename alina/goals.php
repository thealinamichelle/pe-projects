...
$sections = [
		...
		"tasks" => [
			...
			"Working for a company that supports healthy work-life balance through:" . "<ul>" . "<li>" . "unlimited PTO" . "<li>" . "working from home" . "<li>" . "support systems for nuerodivergent employees.",
